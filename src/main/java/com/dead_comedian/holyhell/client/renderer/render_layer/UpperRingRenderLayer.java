...
public class UpperRingRenderLayer<T extends LivingEntity> extends RenderLayer<T, PlayerModel<T>> {
    ...
    public UpperRingRenderLayer(RenderLayerParent<T, PlayerModel<T>> context, EntityModelSet loader) {
        super(context);
