...
public class GateRenderer extends EntityRenderer<GateEntity> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(HolyHell.MOD_ID, "textures/entity/gate.png");
    ...
    public void render(GateEntity mobEntity, float f, float g, PoseStack matrixStack,
        ...
        this.model.renderToBuffer(matrixStack, vertexConsumer, i, OverlayTexture.NO_OVERLAY, 1.0F, 1.0F, 1.0F, 5.0F);
