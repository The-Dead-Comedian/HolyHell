...
public class ReligiousRingsLowerFeatureRenderer<T extends LivingEntity> extends RenderLayer<T, PlayerModel<T>> {
    ...
    public ReligiousRingsLowerFeatureRenderer(RenderLayerParent<T, PlayerModel<T>> context, EntityModelSet loader) {
        super(context);
