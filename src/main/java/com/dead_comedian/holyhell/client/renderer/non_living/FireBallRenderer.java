...
public class FireBallRenderer extends EntityRenderer<FireBallEntity> {
    int timer = 1;
    private static final ResourceLocation TEXTURE1 = ResourceLocation.fromNamespaceAndPath(Holyhell.MOD_ID, "textures/entity/fireball/fireball1.png");
    private static final ResourceLocation TEXTURE2 = ResourceLocation.fromNamespaceAndPath(Holyhell.MOD_ID, "textures/entity/fireball/fireball2.png");
    private static final ResourceLocation TEXTURE3 = ResourceLocation.fromNamespaceAndPath(Holyhell.MOD_ID, "textures/entity/fireball/fireball3.png");
