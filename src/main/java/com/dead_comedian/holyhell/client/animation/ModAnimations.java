    ...
    public static final AnimationDefinition DEVOUT_IDLE = AnimationDefinition.Builder.withLength(1.5f).looping()
            ...
            .addAnimation("left_hand",
                    new AnimationChannel(AnimationChannel.Targets.POSITION,
                            ...
                            new Keyframe(1.5f, KeyframeAnimations.posVec(0f, 0f, 0f),
                                    AnimationChannel.Interpolations.CATMULLROM))).build();
    public static final AnimationDefinition DEVOUT_PRAY = AnimationDefinition.Builder.withLength(0f).looping()
            .addAnimation("body",
                    new AnimationChannel(AnimationChannel.Targets.POSITION,
            ...
            .addAnimation("robe",
                    new AnimationChannel(AnimationChannel.Targets.SCALE,
                            new Keyframe(0f, KeyframeAnimations.scaleVec(1.08f, 0.85f, 1.08f),
                                    AnimationChannel.Interpolations.CATMULLROM))).build();
