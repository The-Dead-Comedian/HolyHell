...
public class LightBeamModel3<T extends LightBeamEntity> extends HierarchicalModel<T> {
	...
	public static LayerDefinition getTexturedModelData() {
		...
		PartDefinition faze3 = bone.addOrReplaceChild("faze3", CubeListBuilder.create().texOffs(128, 137).addBox(-8.0F, -51.5F, -8.0F, 16.0F, 103.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.5F, 51.5F, -11.5F));
