...
public class BabThreeModel <T extends BabThreeEntity> extends SinglePartEntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		.uv(0, 16).cuboid(-6.0F, -2.5F, -6.0F, 12.0F, 2.0F, 12.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -8.5F, 0.0F));
		...
		ModelPartData left_leg = bone.addChild("left_leg", ModelPartBuilder.create().uv(0, 47).cuboid(-2.0F, -0.5F, -2.0F, 4.0F, 5.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -4.5F, 3.0F));

		ModelPartData right_leg = bone.addChild("right_leg", ModelPartBuilder.create().uv(0, 47).cuboid(-2.0F, -0.5F, -2.0F, 4.0F, 5.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -4.5F, -3.0F));
