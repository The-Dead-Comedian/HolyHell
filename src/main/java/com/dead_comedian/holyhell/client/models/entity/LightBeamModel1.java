...
public class LightBeamModel1 <T extends LightBeamEntity> extends HierarchicalModel<T> {
	private final ModelPart bone;

	public LightBeamModel1(ModelPart root) {
	...
	public static LayerDefinition getTexturedModelData() {
		...
		PartDefinition faze1 = bone.addOrReplaceChild("faze1", CubeListBuilder.create().texOffs(0, 137).addBox(-8.0F, -51.5F, -8.0F, 16.0F, 103.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.5F, 51.5F, -11.5F));
