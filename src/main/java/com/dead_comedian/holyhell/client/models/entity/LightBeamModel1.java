...
public class LightBeamModel1<T extends LightBeamEntity> extends SinglePartEntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData faze1 = bone.addChild("faze1", ModelPartBuilder.create().uv(0, 137).cuboid(-8.0F, -51.5F, -8.0F, 16.0F, 103.0F, 16.0F, new Dilation(0.0F)), ModelTransform.pivot(-1.5F, -51.5F, -11.5F));
