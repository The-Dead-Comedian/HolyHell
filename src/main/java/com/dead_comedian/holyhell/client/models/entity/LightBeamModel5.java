...
public class LightBeamModel5<T extends LightBeamEntity> extends HierarchicalModel<T> {
	private final ModelPart bone;

	public LightBeamModel5(ModelPart root) {
	...
	public static LayerDefinition getTexturedModelData() {
		...
		PartDefinition faze5 = bone.addOrReplaceChild("faze5", CubeListBuilder.create().texOffs(191, 7).addBox(-8.0F, 51.5F, -8.0F, 16.0F, 103.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.5F, -51.5F, -11.5F));
