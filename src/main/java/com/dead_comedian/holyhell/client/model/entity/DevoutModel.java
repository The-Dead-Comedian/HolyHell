...
//		this.animate(entity.rangeAttackAnimationState, ModAnimations.DEVOUT_CAST, ageInTicks, 1f);
//		this.animate(entity.meleeAttackAnimationState, ModAnimations.DEVOUT_STAB, ageInTicks, 1f);
//	}
