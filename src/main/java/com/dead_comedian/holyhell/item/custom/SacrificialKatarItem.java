...
public class SacrificialKatarItem extends SwordItem {
    ...
    public SacrificialKatarItem(Tier toolMaterial, int attackDamage, float attackSpeed, Properties settings) {
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pUsedHand) {
        ...
        if (!pPlayer.hasEffect(HolyHellEffects.BLOODLUST.get())) {
