package com.dead_comedian.holyhell.particle.stun_particles;
...
public class StunParticle1 extends TextureSheetParticle {
    private final SpriteSet spriteProvider;
    private boolean birtd;

    StunParticle1(ClientLevel world, double x, double y, double z, SpriteSet spriteProvider, boolean birtd) {
        super(world, x, y, z);
    ...
    public void tick() {
        ...
        if (birtd) {
            ...
            float speed = 0.5F;  // Speed of rotation
    ...
    public record Provider(SpriteSet spriteProvider) implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType defaultParticleType, ClientLevel clientWorld, double d, double e, double f, double g, double h, double i) {
            ...
            return new StunParticle1(clientWorld, d, e, f, this.spriteProvider, true);
        }
    }
}
