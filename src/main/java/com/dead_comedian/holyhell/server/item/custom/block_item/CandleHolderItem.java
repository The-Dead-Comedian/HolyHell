...
public class CandleHolderItem extends BlockItem {
    public CandleHolderItem(Block block, Properties settings) {
    ...
    public InteractionResult place(BlockPlaceContext itemPlaceContext) {
        ...
        BlockPos endPos;
            ...
            endPos = switch (direction) {
                case NORTH -> pos.offset(0, 2, 0);
                case SOUTH -> pos.offset(0, 2, 0);
                case EAST -> pos.offset(0, 2, 0);
                case WEST -> pos.offset(0, 2, 0);
                case UP, DOWN -> null;
            };
