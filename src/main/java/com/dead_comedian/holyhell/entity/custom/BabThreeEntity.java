...
public class BabThreeEntity extends HostileEntity {
    ...
    public BabThreeEntity(EntityType<? extends HostileEntity> entityType, World world) {
    ...
    public void tick() {
        ...
        for (Entity i : entityBelow) {
            if (i instanceof BabThreeEntity) {
                if (((BabThreeEntity) i).getLevel() == 0 && this.getLevel() <= 2) {
    ...
    private static final TrackedData<Integer> LEVEL =
            DataTracker.registerData(BabThreeEntity.class, TrackedDataHandlerRegistry.INTEGER);
