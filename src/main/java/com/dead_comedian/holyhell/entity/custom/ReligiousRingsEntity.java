...
public class ReligiousRingsEntity extends Entity {

    private boolean startedAttack;
    private int ticksLeft;
    private int warmup = 0;

    public ReligiousRingsEntity(EntityType<? extends ReligiousRingsEntity> entityType, World world) {
        super(entityType, world);
        this.ticksLeft =22;
    }

    public ReligiousRingsEntity(World world, double x, double y, double z, float yaw) {
        this((EntityType<? extends ReligiousRingsEntity>) ModEntities.RELIGIOUS_RINGS, world);
    ...
    private static final TrackedData<Boolean> ATTACKING =
            DataTracker.registerData(ReligiousRingsEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
